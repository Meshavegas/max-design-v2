  ...
  return (
    <div className="flex flex-col justify-center items-center gap-4 bg-light md:py-10 bg-opacity-70 ">
      ...
      <div className="flex flex-col items-center gap-4 md:w-full">
        ...
        <div className=" flex gap-4 text-2xl flex-col mt-2 md:flex-row md:w-1/2">
          <div className="h1 flex gap-4 outline cursor-pointer px-4 py-3 rounded-2xl text-white md:w-1/2 items-center">
            <BiPhoneCall /> +237 681 41 52 23
          </div>
          <div className="h1 flex gap-4 bg-white cursor-pointer px-4 py-3 rounded-2xl text-light items-center md:w-1/2">
            {" "}
            <FaWhatsapp />
            Discuter
          </div>
